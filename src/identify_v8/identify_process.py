...
class BaseIdentifyProcess():
    ...
    def deal_process(self, precursor_id_list_arr):
        ...
        try:
            ...
            diabert_model = model_handler.load_model(self.input_param.xrm_model_file, score_device)
            diabert_model = diabert_model.to(score_device)
            sc_deal_thread = ScorePredictThread('score deal', diabert_model, score_device,
