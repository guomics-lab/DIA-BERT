...
class IdentifyProcessHandler():
    ...
    def process_rt_model_params(self, mzml_path, ms1, ms2, win_range):
        if self.input_param.tp_version == 'v1':
            ...
            rt_dia_bert_model = model_handler.load_model(self.input_param.xrm_model_file, rt_score_device)
            rt_sc_deal_thread = ScorePredictThread('rt score deal', rt_dia_bert_model, rt_score_device,
