...
class RunInfoPanel(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.Size(400, 100), style=wx.TAB_TRAVERSAL,
        ...
        run_info_gb_sizer.Add(self.config_panel, wx.GBPosition(0, 0), wx.GBSpan(6, 7), wx.ALL, 5)
        run_info_gb_sizer.Add(self.input_panel, wx.GBPosition(6, 0), wx.GBSpan(2, 7), wx.ALL, 5)
...
class ConfigPanel(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition, size=wx.Size(550, 550), style=wx.TAB_TRAVERSAL,
                 name=wx.EmptyString):
        wx.Panel.__init__(self, parent, id=id, pos=pos, size=size, style=style, name=name)
        ...
        train_pkl_size = pkl_size_util.calculate_pkl_size(min_free_memory)
        quant_pkl_size = pkl_size_util.calculate_pkl_size(min_free_memory)
        ...
        train_pkl_size_label = wx.StaticText(self, wx.ID_ANY, u"Train size", wx.DefaultPosition, (label_width, -1),
                                             wx.ALIGN_RIGHT)
        train_pkl_size_label.Wrap(-1)
        input_gb_sizer.Add(train_pkl_size_label, wx.GBPosition(finetune_config_start_row + 2, 0), wx.GBSpan(1, 2),
                           wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)

        self.train_pkl_size_spin_ctrl = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                                      (text_width, -1), wx.SP_ARROW_KEYS, 0, 99999, train_pkl_size)
        input_gb_sizer.Add(self.train_pkl_size_spin_ctrl, wx.GBPosition(finetune_config_start_row + 2, 2),
                           wx.GBSpan(1, 2), wx.ALL, 5)

        algorithm_config_start_row = 13
        ...
        quant_pkl_size_label = wx.StaticText(self, wx.ID_ANY, u"Quant size", wx.DefaultPosition, (label_width, -1),
                                             wx.ALIGN_RIGHT)
        quant_pkl_size_label.Wrap(-1)
        input_gb_sizer.Add(quant_pkl_size_label, wx.GBPosition(algorithm_config_start_row + 1, 4), wx.GBSpan(1, 2),
                           wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)

        self.quant_pkl_size_spin_ctrl = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                                      (text_width, -1), wx.SP_ARROW_KEYS, 0, 99999, quant_pkl_size)

        input_gb_sizer.Add(self.quant_pkl_size_spin_ctrl, wx.GBPosition(algorithm_config_start_row + 1, 6),
                           wx.GBSpan(1, 2), wx.ALL, 5)
