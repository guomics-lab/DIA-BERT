...
class TaskBarIcon(wx.adv.TaskBarIcon):
    def __init__(self, frame):
        ...
        self.frame = frame
        # 设置托盘图标
        icon = wx.Icon('./resource/logo/logo_only.png', wx.BITMAP_TYPE_PNG)
        self.SetIcon(icon, "DIA-BERT")
...
class MainBox(wx.Frame):
    ...
    def __init__(self, ):
        ...
        self.SetIcon(wx.Icon('./resource/logo/logo_only.png', wx.BITMAP_TYPE_PNG))
