...
class RunPanelEventHandler(object):
    ...
    def build_input_param(self) -> InputParam:
        ...
        input_param.train_pkl_size = self.run_info_panel.config_panel.train_pkl_size_spin_ctrl.GetValue()
        input_param.quant_pkl_size = self.run_info_panel.config_panel.quant_pkl_size_spin_ctrl.GetValue()
